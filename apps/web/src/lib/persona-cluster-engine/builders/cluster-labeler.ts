...
규칙:
- 라벨은 5~15자로, 해당 클러스터만의 고유한 특성을 반영하세요
- 설명은 30~50자로, 이 클러스터를 검색하는 사용자의 구체적 니즈를 설명하세요
- 다른 클러스터와 명확히 구별되는 라벨을 사용하세요
- "추천", "비교" 같은 일반적 단어만으로 라벨을 만들지 마세요
- 예시: "겨울 스킨케어 루틴" (O) vs "추천" (X)
- 마케팅 관점에서 유용한 명명
- 한국어 사용`;
