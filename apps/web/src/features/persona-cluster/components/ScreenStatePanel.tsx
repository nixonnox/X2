...
import type { PersonaClusterScreenState } from "../types/viewModel";

type Props = {
  state: PersonaClusterScreenState;
  keyword?: string;
  /** loading 시 표시할 메시지 */
  loadingMessage?: string;
};

export function ScreenStatePanel({ state, keyword, loadingMessage }: Props) {
  // Loading
  ...
  // Success states — render inline banners
